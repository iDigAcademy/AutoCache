...
/**
 * Cacheable Eloquent Builder for SQL Databases
 *
 * Extends the standard Eloquent Builder to provide automatic caching capabilities
 * for SQL database queries. Handles cache key generation, TTL management,
